function [Accuracy, Sensitivity, Fmeasure, Precision, MCC, Dice, Jaccard, Specitivity,class_error] = EvaluateImageSegmentationScores(A, B)
%==========================================================================
